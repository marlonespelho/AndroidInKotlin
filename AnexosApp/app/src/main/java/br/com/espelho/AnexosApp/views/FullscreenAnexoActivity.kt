...
import kotlinx.android.synthetic.main.activity_fullscreen_anexo.*

/**
 * An example full-screen activity that shows and hides the system UI (i.e.
 * status bar and navigation/system bar) with user interaction.
 */
class FullscreenAnexoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fullscreen_anexo)
    ...
    private fun carregarImagem(){
        val imageViewAnexo : ImageView = findViewById(R.id.fullscreen_content)
